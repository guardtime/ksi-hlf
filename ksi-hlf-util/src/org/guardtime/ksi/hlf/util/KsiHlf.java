...
public class KsiHlf {
  ...
  public static void main(String[] args) {
    ...
    if (cmd.hasOption("help")) {
      ...
      // StateList xxx = new StateList();
      // System.out.println("New statelist" + xxx.getClass());
    ...
    try (Gateway gateway = c.getGateway()) {
      ...
      network.addBlockListener((BlockEvent be) -> {
                    ...
                    try {
                      ...
                      log.log(Level.INFO, "  Pushing KSI[" + be.getBlockNumber() + "]" + sig.getKsi().getAggregationTime());
                      KsiContractApi.pushSignature(network, sig);
                    } catch (Exception e) {
